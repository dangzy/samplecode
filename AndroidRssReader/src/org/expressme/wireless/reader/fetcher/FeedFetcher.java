...
public class FeedFetcher {
    ...
    String getAbsoluteUrl(String baseUrl, String href) {
	 int headlen=href.startsWith("http://")?"http://".length():"https://".length();
        if (href.startsWith("/")) {
            int n = baseUrl.indexOf('/', headlen);
            if (n==(-1))
                return baseUrl + href;
        ...
        baseUrl = trimWithSlash(baseUrl,headlen);
    ...
    String trimWithSlash(String url, int headlen) {
